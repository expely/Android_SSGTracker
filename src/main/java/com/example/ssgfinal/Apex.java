...
public class Apex extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window = Apex.this.getWindow();
        ...
        window.setStatusBarColor(ContextCompat.getColor(Apex.this, R.color.black));
        ...
        Apex.Content content = new Apex.Content();
        content.execute();
    ...
    private class Content extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            progressBar.startAnimation(AnimationUtils.loadAnimation(Apex.this, android.R.anim.fade_in));
        }
        ...
        protected void onPostExecute(Void unused) {
            ...
            progressBar.startAnimation(AnimationUtils.loadAnimation(Apex.this, android.R.anim.fade_out));
        ...
        protected Void doInBackground(Void... voids) {
            try {
                String url = "https://www.spacestationgaming.com/apex-legends";
