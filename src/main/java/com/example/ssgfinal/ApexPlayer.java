...
public class ApexPlayer extends AppCompatActivity {
...
/*                            for (Element elementss : elements) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apex_player);

        Window window = ApexPlayer.this.getWindow();
        ...
        window.setStatusBarColor(ContextCompat.getColor(ApexPlayer.this, R.color.black));

        titleText = findViewById(R.id.textViewTitleA);
        imageView = findViewById(R.id.imageViewA);

        titleText.setText(getIntent().getStringExtra("title"));
        Picasso.get().load(getIntent().getStringExtra("image")).into(imageView);

        RecyclerView listView = findViewById(R.id.recyclerViewA);
        ...
        try {
            ...
            String player = getIntent().getStringExtra("title");
            if (player.equals("Frexs")) {
                browser.loadUrl("https://apex.tracker.gg/apex/profile/origin/SSG_Frexs/overview");
                browser.loadUrl(browser.getUrl());
            } else if (player.equals("Xenial")) {
                browser.loadUrl("https://apex.tracker.gg/apex/profile/origin/SSG_Xenial/overview");
                browser.loadUrl(browser.getUrl());
            } else if (player.equals("Dropped")) {
                browser.loadUrl("https://apex.tracker.gg/apex/profile/origin/SSG_Dropped/overview");
                browser.loadUrl(browser.getUrl());
            }
