...
public class SmashPlayer extends AppCompatActivity {
...
/*                            for (Element elementss : elements) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_smash_player);

        Window window = SmashPlayer.this.getWindow();
        ...
        window.setStatusBarColor(ContextCompat.getColor(SmashPlayer.this, R.color.black));

        titleText = findViewById(R.id.textViewTitleS);
        imageView = findViewById(R.id.imageViewS);

        titleText.setText(getIntent().getStringExtra("title"));
        Picasso.get().load(getIntent().getStringExtra("image")).into(imageView);

        RecyclerView listView = findViewById(R.id.recyclerViewS);
